    ...
    public static void main(String[] args) {
        ...
        if (idade1 < 15) {
            if (nivelMissao1 == 'C' || nivelMissao1 == 'D') {
                System.out.println("Concluidaaaaa");
            } else {
        ...
        if (idade1 < 15) {
            if (nivelMissao1 == 'C' || nivelMissao1 == 'D') {
                statusMissao2 = "Concluidaaaaa";
            } else {
                statusMissao2 = "Nao foi possivel concluir a misão, você não tem idade suficiente .";
            }

        } else {
            statusMissao2 = "Concluida com sucesso.";
        }
        ...
        if (idade3 < 15) {
            if (nivelMissao3 == 'C' || nivelMissao3 == 'D') {
                statusMissao3 = "Concluidaaaaa";
            } else {
                statusMissao3 = "Você não tem idade vá dormir ...";
            }

        } else {
            statusMissao3 = "Concluida com sucesso.";
        }
